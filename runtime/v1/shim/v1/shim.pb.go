...
// source: github.com/demonoid81/containerd/runtime/v1/shim/v1/shim.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/runtime/v1/shim/v1/shim.proto", fileDescriptor_be1b2ef30ea3b8ef)
}
