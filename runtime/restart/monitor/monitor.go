...
import (
	...
	containers "github.com/demonoid81/containerd/api/services/containers/v1"
	diff "github.com/demonoid81/containerd/api/services/diff/v1"
	images "github.com/demonoid81/containerd/api/services/images/v1"
	namespacesapi "github.com/demonoid81/containerd/api/services/namespaces/v1"
	tasks "github.com/demonoid81/containerd/api/services/tasks/v1"
	...
	"github.com/demonoid81/containerd/runtime/restart"
