...
(`github.com/demonoid81/containerd`) has built-in behavior to ensure resources
...
Use `client.LeasesService()` to get a [lease Manager](https://godoc.org/github.com/demonoid81/containerd/leases#Manager)
...
leases. Use [`images.SynchronousDelete()`](https://godoc.org/github.com/demonoid81/containerd/images#SynchronousDelete)
for [`images.Store`](https://godoc.org/github.com/demonoid81/containerd/images#Store)'s
`Delete` and
[`leases.SynchronousDelete`](https://godoc.org/github.com/demonoid81/containerd/leases#SynchronousDelete)
for [`leases.Manager`](https://godoc.org/github.com/demonoid81/containerd/leases#Manager)'s
`Delete`.
