...
// source: github.com/demonoid81/containerd/api/services/introspection/v1/introspection.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/api/services/introspection/v1/introspection.proto", fileDescriptor_1a14fda866f10715)
}
...
var _Introspection_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/demonoid81/containerd/api/services/introspection/v1/introspection.proto",
}
