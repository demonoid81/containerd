...
// source: github.com/demonoid81/containerd/api/services/ttrpc/events/v1/events.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/api/services/ttrpc/events/v1/events.proto", fileDescriptor_19f98672016720b5)
}
