...
// source: github.com/demonoid81/containerd/api/events/namespace.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/api/events/namespace.proto", fileDescriptor_6cd45d1d5adffe29)
}
