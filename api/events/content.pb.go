...
// source: github.com/demonoid81/containerd/api/events/content.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/api/events/content.proto", fileDescriptor_dfb34b8b808e2ecd)
}
