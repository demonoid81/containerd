...
// source: github.com/demonoid81/containerd/api/events/task.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/api/events/task.proto", fileDescriptor_8db0813f7adfb63c)
}
