...
// source: github.com/demonoid81/containerd/api/types/task/task.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/api/types/task/task.proto", fileDescriptor_391ef18c8ab0dc16)
}
