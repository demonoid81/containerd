...
// source: github.com/demonoid81/containerd/api/types/metrics.proto
...
func init() {
	proto.RegisterFile("github.com/demonoid81/containerd/api/types/metrics.proto", fileDescriptor_8d594d87edf6e6bc)
}
