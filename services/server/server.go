...
import (
	...
	csapi "github.com/demonoid81/containerd/api/services/content/v1"
	ssapi "github.com/demonoid81/containerd/api/services/snapshots/v1"
	"github.com/demonoid81/containerd/content"
	"github.com/demonoid81/containerd/content/local"
	csproxy "github.com/demonoid81/containerd/content/proxy"
	...
	ssproxy "github.com/demonoid81/containerd/snapshots/proxy"
